...
It verifies: exactly 103 topics with 10 items each; required topic/item fields are
...
14 categories, 103 topics, 1,030 vocabulary words in `src/data/topics.json`.
