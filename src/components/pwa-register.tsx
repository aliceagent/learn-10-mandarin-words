  ...
  return (
    <div className="fixed inset-x-0 bottom-20 z-40 mx-auto flex max-w-sm items-center gap-3 rounded-2xl border border-white/10 bg-slate-900/95 px-4 py-3 shadow-2xl backdrop-blur md:bottom-6">
      ...
      <button
        ...
        className="shrink-0 rounded-full bg-emerald-400 px-4 py-2 text-sm font-semibold text-slate-950 transition hover:bg-emerald-300"
      >
        Install
      </button>
      <button
        ...
        className="shrink-0 rounded-full border border-white/10 px-2.5 py-2 text-sm text-slate-400 transition hover:text-white"
      >
        ✕
      </button>
    </div>
